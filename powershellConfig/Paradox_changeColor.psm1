...
# changed Color and FailedCommandSymbol, add a symbol at the front of StartSymbol based on Paradox.
...
$sl.Colors.PromptIndicatorForegroundColor1 = [ConsoleColor]::DarkYellow
$sl.Colors.PromptIndicatorForegroundColor2 = [ConsoleColor]::DarkGreen